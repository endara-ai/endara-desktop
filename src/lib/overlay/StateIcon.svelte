...
{:else if state === 'success'}
  <svg width={size} height={size} viewBox="0 0 14 14" style:color data-testid="state-icon" data-state="success">
    <path d="M3 7.2l2.7 2.6 5.4-5.6" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" />
  </svg>
{:else}
  <svg width={size} height={size} viewBox="0 0 14 14" style:color data-testid="state-icon" data-state="fail">
